		<?php  $titre = 'Prixy - Notre Equipe'; include("barnav.php"); ?>		
			<div class="container">
				...
				<div class="row col-xs-12 text-justify">
					<p class="pres-equipe">
						Créée fin 2013 par deux associés, <span style="color:#ff1919; font-weight:bold;">S. Millot</span> et <span style="color:#b7b700; font-weight:bold;">C. Joubert</span> et implantée à Lyon, la société PRIXY s'occupe du marché de la formation à destination des professionnels. PRIXY s’adresse principalement aux petites et moyennes entreprises ainsi qu’aux collectivités ; elle accompagne ses clients dans la définition et la mise en oeuvre de solutions de formation. En 2015, PRIXY a assuré la montée en compétences de près de <b>2 500 collaborateurs</b> des secteurs privés et publics, pour un chiffre d’affaires de <b>950 000 €</b>.
					</p><br>
				</div>
			</div>
			<div class="container-fluid">
				...
				<div class="row col-lg-6 col-lg-offset-3 text-justify">
					...
					<p class="pres-equipe">
						Les formations durent de <b>2 à 5 jours.</b><br><br>

						Les stages se déroulent de <b>9h00 à 17h30</b> garantissant 7 heures de formation par jour. Ces horaires <b>peuvent être adaptés</b> le dernier jour en fonction des impératifs des participants (train, avion). Le premier jour, les participants sont accueillis à partir de 8h45, la présentation de la session ayant lieu de 9h15 à 9h30.<br><br>
					</p>
				</div>
			</div>
		</div>
